...
const TermsandPolicy = () => {
  return (
    <div className="px-7 pt-24 pb-5 md:px-16 lg:py-10">
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-7">
          <p className="text-gray-900">
            Please carefully review the following terms and conditions ("Terms")
            as they will govern your access to and use of the Site. If you do
            not agree to these Terms, please exit the Site immediately. By
            accessing and using the Site, you indicate your acceptance of these
            Terms.
          </p>
          <div className="flex flex-col gap-7">
            <div className="flex flex-col gap-2 ">
              ...
              <p className="text-gray-900">
                ...
                portion of the Site Content. The term "Site Content" encompasses
                text, graphics, audio, video, data, interactive features, and
                any other materials published on the Site or its associated
                pages.
              </p>
              <p className="text-gray-900">
                ...
                use of such materials is strictly prohibited under copyright,
                trademark, and other pertinent laws.
              </p>
              <p className="text-gray-900">
                With the exception of what is expressly permitted under these
                Terms, you are not authorized to store, distribute, display,
                sell, or exploit the Site Content in any manner. While you may
                occasionally print a single copy of a page from the Site for
                personal, non-commercial use, it is essential to note that
                multiple copies intended for distribution to others are strictly
                prohibited.
              </p>
              <p className="text-gray-900">
            ...
            <div className="flex flex-col gap-2 ">
              ...
              <p className="text-gray-900">
                ...
                purposes. It should be perceived as a manageable source
                encompassing only some possible medical conditions that may
                affect your pet. Consequently, it is imperative that you do not
                consider the information presented on this site as a replacement
              ...
              <p className="text-gray-900">
                ...
                from either your failure to seek appropriate veterinary
                assistance or your reliance on the information provided on this
                site.
              </p>
              <p className="text-gray-900">
                Therefore, it is strongly recommended that, in the event of any
                health concerns or medical issues pertaining to your pet, you
                promptly consult a qualified veterinarian who can provide
                accurate and tailored advice based on your pet's specific
                circumstances. Your veterinarian possesses the necessary
                expertise to thoroughly evaluate and diagnose your pet's
                condition and to recommend appropriate treatment options
              </p>
              <p className="text-gray-900">
            ...
            <div className="flex flex-col gap-2 ">
              ...
              <p className="text-gray-900">
                ...
                using this Site. Moreover, even individuals older than 18 who
                are considered minors according to applicable laws must seek
                parental consent before accessing and utilizing the Site.
              </p>
              <p className="text-gray-900">
                In the event that you do not meet the legal age requirement to
                access and use this Site without parental consent, it is
                imperative that you obtain permission from your parent or legal
                guardian before proceeding to access and use the Site. This
                requirement is in place to ensure compliance with legal
                obligations and to maintain the safety and well-being of all
                users
              </p>
              <p className="text-gray-900">
              ...
              <p className="text-gray-900">
                By accessing and using the Site, you acknowledge and confirm
            ...
            <div className="flex flex-col gap-2 ">
              ...
              <p className="text-gray-700">
                As a user of this Site, you may have the opportunity to
              ...
              <p className="text-gray-700">
                In order to submit User Content, it may be necessary for you to
                create an account and provide certain personal information,
                including your name, email address, telephone number, and home
                or business address. Alternatively, other means of communication
                may not require account creation. The use of any personal
                information you disclose will be governed by our Privacy Policy,
              ...
              <p className="text-gray-700">
                ...
                it on the Site. This license also extends to your name, Site
              ...
              <p className="text-gray-700">
                ...
                adheres to our guidelines and policies.
              </p>
            </div>
          </div>
        </div>
